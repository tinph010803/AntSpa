...
const WeightLossTreatment = () => {
  ...
  const filters = {
    ...
    type: ["Gel giảm béo", "Tinh dầu", "Serum", "Kem dưỡng", "Nước tẩy trang"],
    brand: ["Scentuals", "Talika", "Byphasse", "Health Basics", "La Roche Posay"],
  ...
  return (
    <section className="bg-gray-50 py-10">
      <div className="container mx-auto px-4">
        {/* TIÊU ĐỀ */}
        <h2 className="text-center text-3xl font-bold text-yellow-500 mb-6">Giảm cân và Giảm béo</h2>
