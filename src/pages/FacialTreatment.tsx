...
const FacialTreatment = () => {
  ...
  const filters = {
    ...
    type: ["Tinh dầu", "Serum", "Kem dưỡng", "Gel trị liệu", "Nước tẩy trang", "Dầu gội", "Sữa trị nám"],
    brand: ["Scentuals", "Talika", "Byphasse", "La Roche Posay", "Transino", "Sensibio"],
    skin: ["Da dầu", "Da khô", "Da mụn", "Da nhạy cảm", "Da hỗn hợp", "Da lão hóa"],
  }
  ...
  const products = [
    ...
    {
      id: 6,
      name: "Gel Sébium Gommant Cho Da Dầu & Hỗn Hợp 100ml (Tặng: Sữa Rửa Mặt Cho Da Nhạy Cảm La Roche Posay 4ml)",
      price: "379.000đ",
      originalPrice: "425.000đ",
      discount: "-11%",
      image:
        "https://bizweb.dktcdn.net/thumb/large/100/312/429/products/nuoc-tay-trang-c29b220f-8f3e-4f37-b39b-38e6d2f8455a.jpg?v=1525613025910",
    },
    {
      id: 7,
  ...
  return (
    <section className="bg-gray-50 py-10">
      <div className="container mx-auto px-4">
        {/* TIÊU ĐỀ */}
        <h2 className="text-center text-3xl font-bold text-yellow-500 mb-6">Trị liệu da mặt</h2>
