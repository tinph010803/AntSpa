        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="relative mb-6">
              <div className="w-64 h-64 mx-auto rounded-full border-4 border-yellow-400 overflow-hidden shadow-xl">
                <img
            ...
            <div className="bg-yellow-400 text-white px-6 py-2 rounded-full inline-block mb-4 shadow-md">
